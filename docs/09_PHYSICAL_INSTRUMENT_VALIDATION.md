...
|---|---|---|---|---|---|---|---|---|---|
| T-CONN-01-03 | Sysmex XN-550 | Role / IP / port / protocol / framing | P2 | **FIELD TESTED** (2026-09-16) — endpoint, role, protocol and framing established for the tested configuration; inbound tested on **port 5001 only**. See `docs/instruments/sysmex_xn550/VALIDATION_2026-09-16.md` | Endpoint + protocol confirmation | No | No | No | **Yes** |
| T-CORPUS-01-03 | Sysmex XN-550 | Raw message corpus | P2 | **IN PROGRESS** — 7 messages / 4 distinct payloads captured 2026-09-16, all patient-result; **zero** QC, calibration, maintenance or startup captures. Gate **not** met | ≥20 raw messages across categories | Yes | Yes | Yes | **Yes** |
