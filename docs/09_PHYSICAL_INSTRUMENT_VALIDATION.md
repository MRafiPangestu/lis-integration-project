...
| T-CORPUS-01-03 | Sysmex XN-550 | Raw message corpus | P2 | **IN PROGRESS** — 12 messages (1 + 7 + 4 across 2026-09-15/16/17) plus 1 uncontrolled message of unknown class; 8 distinct patient-result payloads; **zero** QC, calibration, maintenance or startup captures. Gate **not** met | ≥20 raw messages across categories | Yes | Yes | Yes | **Yes** |
